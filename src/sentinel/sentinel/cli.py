...
def main():
    ...
    monitor_parser.add_argument("--interval", type=int, default=0, help="Monitoring interval (in seconds)")
    monitor_parser.add_argument("--count", type=parse_count, default=None, help='Number of times to poll. Use "None" to poll indefinitely.')
